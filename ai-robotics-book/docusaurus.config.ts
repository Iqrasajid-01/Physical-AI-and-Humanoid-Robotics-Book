...
const config: Config = {
  ...
  tagline: 'A Complete Textbook for AI-Driven Humanoids 📚',
  ...
  url: 'https://iqrasajid-01.github.io',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Iqrasajid-01',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Created by Iqra Sajid`,
    },
    prism: {
